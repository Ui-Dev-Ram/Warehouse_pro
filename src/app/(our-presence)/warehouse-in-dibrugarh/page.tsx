...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.dibrugarh;
  ...
  return (
    <div>
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.dibrugarh.sideimg} alt="warehouse in dibrugarh" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.dibrugarh.location} />
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez in Dibrugarh ?
                        </h2>
      ...
      <div className="container max-w-screen-xl mx-auto">
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            If you are searching for a warehouse for rent in Dibrugarh or any other city of India, then Warehouzez has got you covered. Contact us today and get access to phenomenal warehousing and logistics services as per your requirements.
        </p>
