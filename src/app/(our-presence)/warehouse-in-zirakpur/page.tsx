...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.zirakpur;
          ...
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <p className=" block antialiased font-sans lg:text-base leading-relaxed text-gray-700 text-justify font-normal text-sm md:text-md xl:text-lg mb-10">
                    Warehouzez: Delivering The Finest- Quality Warehousing <br /> And Logistics Services!
                  </p>
              ...
              <div className="flex mx-auto lg:mx-0 align-middle">
                  <Image src={cities.zirakpur.cityimg} className='f-3/4 m-auto' width={500} height={500} alt="Image" />
              </div>
          </div>
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            <span className='text-4xl font-bold text-red pr-0.5'>T</span>he logistics industry has played a critical role in propelling several other industries as India's growth model has evolved tremendously. The key driving forces for growth in the warehousing sector are Retailing, E-commerce, modernized and advanced technologies. India's warehousing industry has been rapidly developing due to a rise in economic growth and export business. All the individuals, business owners, and stakeholders looking for a warehouse in Zirakpur or any other city should contact Warehouzez. Warehouzez is certainly one of the most significant warehousing companies in India. We offer innovative and tailor-made warehousing solutions along with top-class infrastructure for businesses. Our team of experts can help you with customized warehouse and logistical operations, short and long-term storage facilities, and other value-added solutions. Warehouzez is a prominent, popular and most preferred third party logistics partner (3PL) in the country.
          </p>
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.zirakpur.sideimg} alt="warehouse in zirakpur" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.zirakpur.location} /> 
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez in Zirakpur?
                        </h2>
