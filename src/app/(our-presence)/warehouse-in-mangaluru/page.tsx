...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.mangaluru;
  ...
  return (
    <div>
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <p className=" block antialiased font-sans lg:text-base leading-relaxed text-gray-700 text-justify font-normal text-sm md:text-md xl:text-lg mb-10">
                    Warehouzez: Get Excellent Warehousing And Logistics Solutions <br /> For Your Business!
                  </p>
              ...
              <div className="flex mx-auto lg:mx-0 align-middle">
                  <Image src={cities.mangaluru.cityimg} className='f-3/4 m-auto' width={500} height={500} alt="Image" />
              </div>
          </div>
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            <span className='text-4xl font-bold text-red pr-0.5'>T</span>he warehousing industry's scope has expanded as the Indian economy is growing tremendously and the corporate perspectives are changing. The construction of production units has raised the demand for warehouse space to manage inventory stock, resulting in a substantial increase in trade opportunities.For all the people, investors, entrepreneurs or firms looking for a warehouse in Mangaluru should connect and shake hands with Warehouzez. Warehouzez is certainly one of the most significant warehousing companies in India. We have a country-wide network of warehouses where you can keep your company's inventory stock in the most convenient location. By providing a wide assortment of outstanding logistics solutions, we inevitably assist organisations in reaching their full potential.
          </p>
          ...
          <h2 className='block antialiased tracking-normal font-sans text-2xl lg:text-2xl font-bold leading-[1.3] text-blue-gray-900 mb-2 mt-10'>
            Superior-Quality Warehousing Services
          </h2>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Mangaluru is a prominent industrial hub of Karnataka. The prominent industries in this city include Fashion and Lifrstyle, E-Commerce and FMCG, Computer and Electrical, among others. The city has phenomenal business opportunities for everyone out there. Warehousing and logistics are inextricably linked to every company's success. For all those looking for a warehouse for rent in Mangaluru, should connect with Warehouzez. Warehouzez is a leading and efficient logistics service provider in the country. It offers end-to-end storage solutions for a variety of sectors. You can get the greatest possible offerings and best-in-class solutions by choosing Warehouzez. It is a one-stop destination for all supply chain management operations and effective warehouse management solutions.
          </p>
        </div>     
      </div> 
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.mangaluru.sideimg} alt="warehouse in mangaluru" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.mangaluru.location} /> 
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez in Mangaluru?
                        </h2>
      ...
      <div className="container max-w-screen-xl mx-auto">
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            If you're looking for a warehouse in Mangaluru, there's no need to look anywhere else. For a wide spectrum of industries, Warehouzez provides the best logistics and warehouse solutions. We use performance enhancing techniques to attain maximum efficiency. If you're searching for a 3PL partner to help you scale your business, contact us immediately.
        </p>
