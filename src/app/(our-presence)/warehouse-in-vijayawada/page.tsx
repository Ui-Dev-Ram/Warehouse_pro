...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.vijayawada;
    ...
    <div>
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <p className=" block antialiased font-sans lg:text-base leading-relaxed text-gray-700 text-justify font-normal text-sm md:text-md xl:text-lg mb-10">
                    Warehouzez: Superior Quality Warehousing And Logistics <br /> Services To Make Your Business Profitable!
                  </p>
              ...
              <div className="flex mx-auto lg:mx-0 align-middle">
                  <Image src={cities.vijayawada.cityimg} className='f-3/4 m-auto' width={500} height={500} alt="Image" />
              </div>
          </div>
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            <span className='text-4xl font-bold text-red pr-0.5'>T</span>he Indian economy is accelerating and the industrial sectors are becoming all the more dominant. As a result, the warehousing and logistics industry is also receiving more and more attention. Warehousing is fundamentally essential for the growth and success of any business. Different types of businesses demand for warehouses to store their inventory stock in the safest possible manner. For all the individuals, firms, investors, or entrepreneurs, looking for a warehouse in Vijayawada or any other city of the country should contact Warehouzez. Warehouzez is certainly one of the most significant warehousing companies in India. We offer innovative, modernized and tailor-made inventory management solutions along with top-class infrastructure for all types of businesses.
          </p>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Our team of experts can help you with customized warehouse and logistical operations, short and long-term storage facilities, and other value-added solutions. Warehouzez is a prominent, popular and most preferred third party logistics partner (3PL) in the country.
          </p>
          ...
          <h2 className='block antialiased tracking-normal font-sans text-2xl lg:text-2xl font-bold leading-[1.3] text-blue-gray-900 mb-2 mt-10'>
            Exclusive Warehousing Services in Vijayawada
          </h2>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            The city of Vijayawada is also known as the Andhra Pradesh's commercial hub. The economy of this city is heavily reliant on trade and business. Being a vibrant commercial and industrial city, it is home to a diverse range of industries like Oil and Chemical, Minerals and Mining, Packed Food Products, Automotive and Spare Parts, among others. Businesses from the aforementioned industrial sectors demand for logistics and warehousing services. For everyone searching for a warehouse in Vijayawada should approach and contact Warehouzez. We have a country-wide network of warehouses where you can keep your company's inventory stock in the most convenient location. Our greatest storage system in India ensures that you have the infrastructure and facilities as per your requirements. We make it a point to use the latest software and technological tools to get the best results. Warehouzez is in the list of top logistics companies of India.
          </p>
        </div>     
      </div> 
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.vijayawada.sideimg} alt="warehouse in vijayawada" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.vijayawada.location} /> 
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez in Vijayawada?
                        </h2>

                        <p className="block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify">
                            To fulfill the needs and demands of our customers, we provide cutting-edge supply chain management and logistics solutions. Warehouzez has extended its spectrum of services and solutions, creating a strong position in India's logistics sector.
                        </p>
      ...
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
            ...
            <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
                Here's how our services can be beneficial for your business
            </p>
            ...
            <ul className='flex items-center flex-wrap gap-y-5 mt-4 mb-6'>
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      To deliver the best-in-class warehousing services, we have large and well-maintained warehouse spaces that provide matchless storage facilities.
                      </span>
                      </div>
                  </li>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      By investing in modernized technological tools and software systems, we provide unparalleled logistical operations.
                      </span>
                      </div>
                  </li>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      We focus on saving your time and costs by delivering autorotation led solutions.
                      </span>
                      </div>
                  </li>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      We specialise in helping our clients expand their share in the emerging and developing economies.
                      </span>
                      </div>
                  </li>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      We certainly help businesses reach their full potential by offering a wide range of exceptional warehouse management solutions.
                      </span>
                      </div>
                  </li>
            </ul> 
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            If you require a warehouse for rent in Vijayawada or any other city of India, then there is no need to go anywhere else. Warehouzez offers excellent logistics and warehouse and distribution options for a multitude of industries. Contact us right away if you're looking for a 3PL partner to help you expand your business.
        </p>
