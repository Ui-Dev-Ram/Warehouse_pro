...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.whitefield;
    ...
    <div>
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.whitefield.sideimg} alt="warehouse in whitefield" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.whitefield.location} />
                        </div>
                  </div>
                    ...
                    <div className="flex-1">
                        ...
                        <p className="block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify">
                            At Warehouzez, we employ advanced technology, software and digital tools. We continuously work on how technology can be better integrated into processes, lowering the risk of human mistake and enhancing the company's digital footprint so that it can reach across the country and provide reliable and smooth services.
                        </p>
      ...
      <div className="container max-w-screen-xl mx-auto">
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-semibold text-gray-700 mb-3 text-justify mt-4'>
            Additionally, we have a motivated and well-trained staff that works as a team and effectively completes all jobs. Our team is experienced in a variety of fields. We integrate our procedures to achieve efficient supply chain management.
        </p>
