...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.rajkot;
    ...
    <div>
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <h1 className="font-bold text-gray-800 text-4xl md:text-6xl xl:text-7xl mb-10">
                      Warehouse in  <br />
                      <span className='text-red'>Rajkot</span>
                  </h1>
              ...
              <div className="flex mx-auto lg:mx-0 align-middle">
                  <Image src={cities.rajkot.cityimg} className='f-3/4 m-auto' width={500} height={500} alt="Image" />
              </div>
          </div>
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            <span className='text-4xl font-bold text-red pr-0.5'>T</span>he warehousing industry's scope has expanded as the Indian economy is growing tremendously and the corporate perspectives are changing. Logistics and Warehousing are important aspects of the burgeoning E-commerce sector. For all the people, investors, entrepreneurs or firms looking for a warehouse in Rajkot should connect and shake hands with Warehouzez. Warehouzez is certainly one of the most significant warehousing companies in India. We have a country-wide network of warehouses where you can keep your company's inventory stock in the most convenient location. Warehouzez a is one-stop destination for all supply chain management operations and effective warehouse management solutions. We make it a point to use the latest software and technological tools to get the best results.
          </p>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Our team of experts can help you with customized warehouse and logistics operations, short and long-term storage facilities, and other value-added solutions. Warehouzez is widely regarded as one of the best logistics companies in India, offering customized and flexible third party logistics solutions.
          </p>
          ...
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Rajkot is one of the most significant cities of Gujarat. It is currently the trade and business hub of South Gujarat, as well as one of Western India's main metropolitan areas. The city's economy is thriving. The prominent industrial sectors in this city include Fashion and Lifestyle, E-Commerce and FMCG, Consumer Goods, among others. As a result, businesses from different industrial sectors demand for a warehouse for rent in Rajkot for various purposes. Warehouzez is the best option for everyone looking for storage spaces or warehousing services. Warehouzez is a popular and preferred third party logistics partner (3PL) in the country. Our greatest storage system in India ensures that you have the infrastructure and facilities as per your requirements.
          </p>
        </div>     
      </div> 
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.rajkot.sideimg} alt="warehouse in rajkot" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.rajkot.location} /> 
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez in Rajkot?
                        </h2>
