...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.surat;
    ...
    <div>
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <h1 className="font-bold text-gray-800 text-4xl md:text-6xl xl:text-7xl mb-10">
                      Warehouse in  <br />
                      <span className='text-red'>Surat</span>
                  </h1>
          ...
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Surat is one of the most significant cities of Gujarat. It is currently the trade and business hub of South Gujarat, as well as one of Western India's main metropolitan areas. The city's economy is thriving. The prominent industrial sectors in this city include Fashion and Lifestyle, E-Commerce and FMCG, Consumer Goods, among others. As a result, businesses from different industrial sectors demand for a warehousing services in Surat for various purposes. Warehouzez is the best option for everyone looking for storage spaces or warehousing services. Warehouzez is a popular and preferred third party logistics partner (3PL) in the country. Our greatest storage system in India ensures that you have the infrastructure and facilities as per your requirements.
          </p>
        </div>     
      </div> 
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.surat.sideimg} alt="warehouse in surat" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.surat.location} /> 
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez in Surat?
                        </h2>
