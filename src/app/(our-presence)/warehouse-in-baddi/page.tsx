...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.baddi;
  ...
  return (
    <div>
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <h1 className="font-bold text-gray-800 text-4xl md:text-6xl xl:text-7xl mb-10">
                      Warehouse in  <br />
                      <span className='text-red'>Baddi</span>
                  </h1>
          ...
          <h2 className='block antialiased tracking-normal font-sans text-2xl lg:text-2xl font-bold leading-[1.3] text-blue-gray-900 mb-2 mt-10'>
            Finest Warehousing Services in Baddi
          </h2>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Baddi is an industrial city and Nagar Parishad is located in the southwest Solan district in Himachal Pradesh, India. Baddi has a variety of pharmaceutical companies that have set up manufacturing facilities as well as R&D centers in the town. It has evolved as the state's most prominent trading and commercial hubs. The key industrial sectors in this city include Packed Food Products, Consumer Goods, Wind, Solar and Telecom, among others. Since, this place offers great business opportunities, the demand for warehousing services is also growing. Businesses from plethora of industrial sectors demand for a warehouse in Baddi. Warehouzez is one of the top logistics companies in India. It offers exceptional warehousing and logistics solutions. We have a country-wide network of warehouses where you can keep your company's inventory stock in the most convenient location. We make it a point to use the latest software and technological tools to get the best results.
          </p>
        </div>     
      </div> 
            ...
            <div className="container max-w-screen-xl mx-auto px-4">
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    ...
                    <Image src={cities.baddi.sideimg} alt="warehouse in baddi" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.baddi.location} />
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez in Baddi ?
                        </h2>
      ...
      <div className="container max-w-screen-xl mx-auto">
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            If you are searching for a warehouse for rent in Baddi or any other city of India, then do contact Warehouzez. We will manage your warehousing and logistical concerns in the perfect manner. So, contact us right away for more information!
        </p>
