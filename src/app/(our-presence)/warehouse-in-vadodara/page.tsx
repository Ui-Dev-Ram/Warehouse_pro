...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.vadodara;
  ...
  return (
    <div>
        ...
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  Warehouzez: Enjoy The Best And Latest Warehousing <br /> And Logistics Services!
                  </p>
              ...
              <div className="flex mx-auto lg:mx-0 align-middle">
                  <Image src={cities.vadodara.cityimg} className='f-3/4 m-auto' width={500} height={500} alt="Image" />
              </div>
          </div>
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            <span className='text-4xl font-bold text-red pr-0.5'>T</span>he warehousing industry's scope has expanded as the Indian economy is growing tremendously and the corporate perspectives are changing. Logistics and Warehousing are important aspects of the burgeoning E-commerce sector. For all the people, investors, entrepreneurs or firms looking for a warehouse in Vadodara should connect and shake hands with Warehouzez. Warehouzez is certainly one of the most significant warehousing companies in India. We have a country-wide network of warehouses where you can keep your company's inventory stock in the most convenient location. Warehouzez a is one-stop destination for all supply chain management operations and effective warehouse management solutions.
          </p>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            We make it a point to use the latest WMS software and technological tools to get the best results. Our team of experts can help you with customized 3PL warehouse and logistics operations, short and long-term storage facilities, and other value-added solutions. Warehouzez is widely regarded as one of the best logistics companies in India, offering warehousing services and flexible third party logistics solutions.
          </p>
          ...
          <h2 className='block antialiased tracking-normal font-sans text-2xl lg:text-2xl font-bold leading-[1.3] text-blue-gray-900 mb-2 mt-10'>
            High-Quality Warehouse Services
          </h2>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Vadodara is one of the most significant cities of Gujarat. It is currently the trade and business hub of South Gujarat, as well as one of Western India's main metropolitan areas. The city's economy is thriving. The prominent industrial sectors in this city include Fashion and Lifestyle, E-Commerce and FMCG, Consumer Goods, among others. As a result, businesses from different industrial sectors demand for a Warehousing services in Vadodara for various purposes. Warehouzez is the best option for everyone looking for storage spaces or warehousing services. Warehouzez is a popular and preferred third party logistics partner (3PL) in the country. Our greatest 3PL warehouse system in India ensures that you have the infrastructure and facilities as per your requirements.
          </p>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Here are the services that we offer with a warehouse in Vadodara
          </p>
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.vadodara.sideimg} alt="warehouse in vadodara" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.vadodara.location} /> 
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez in Vadodara?
                        </h2>
      ...
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
            ...
            <ul className='flex items-center flex-wrap gap-y-5 mt-4 mb-6'>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      Our team ensures the security of your inventory while also saving you money.
                      </span>
                      </div>
                  </li>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      By investing in modernized technological tools and software systems, we provide unparalleled logistical solutions.
                      </span>
                      </div>
                  </li>
            </ul> 
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            So, if you are looking for a warehouse in Vadodara, contact us straight away! We will walk you through the entire supply chain management procedure. Warehouzez is a one-stop store for the best logistical services. Our company is known for its strong corporate principles, high-quality solutions, and steadfast commitment to business excellence.
        </p>
