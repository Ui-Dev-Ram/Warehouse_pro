...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.jammu;
  ...
  return (
    <div>
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <h1 className="font-bold text-gray-800 text-4xl md:text-6xl xl:text-7xl mb-10">
                      Warehouse in  <br />
                      <span className='text-red'>Jammu</span>
                  </h1>
                  ...
                  <p className=" block antialiased font-sans lg:text-base leading-relaxed text-gray-700 text-justify font-normal text-sm md:text-md xl:text-lg mb-10">
                    Warehouzez: Providing The Right Logistics Solutions <br /> For Your Business!
                  </p>
              ...
              <div className="flex mx-auto lg:mx-0 align-middle">
                  <Image src={cities.jammu.cityimg} className='f-3/4 m-auto' width={500} height={500} alt="Image" />
              </div>
          </div>
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            <span className='text-4xl font-bold text-red pr-0.5'>I</span>ndia's Warehousing and Logistics Industry is expanding at a fast pace. These sectors are becoming all the more organized and digitized. Warehousing is utmost important for almost every kind of business. It helps in storing the inventory stock, and optimizing the order fulfillment process. So, for the business executives looking for a warehouse in Jammu or any other city of the country should get in touch with Warehouzez. Warehouzez is indeed the best logistics company in India. Our team of experts can help you with customized warehouse and logistics operations, short and long-term storage facilities, and other value-added solutions. We have a highly sought-after warehouse in Jammu that is strategically located. Warehouzez is a popular and most preferred third party logistics partner (3PL) in the country.
          </p>
          ...
          <h2 className='block antialiased tracking-normal font-sans text-2xl lg:text-2xl font-bold leading-[1.3] text-blue-gray-900 mb-2 mt-10'>
            Top-Class Warehousing Services in Jammu
          </h2>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Jammu and Kashmir (J&K) is an Indian Union Territory (UT) in the country's northern region. It is a popular tourist destination. The economy is mostly centred on services and agricultural sectors. Jammu has a wide range of small and large scale industries like Exhibition and Entertainment, Packed Food Products, Perfumes and Cosmetics, among others. Various business firms demand for a warehouse in Jammu to manage their inventory appropriately. Warehouzez is an-inclusive company that provides best-in-class warehousing services. We have a country-wide network of warehouses where you can keep your company's inventory stock in the most convenient location. We make it a point to use the latest software and technological tools to get the best results. Warehouzez is regarded as one of the top logistics companies in India.
          </p>
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <img src={cities.jammu.sideimg} className='w-5/6' alt="Feature img" />
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.jammu.location} /> 
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                         Why Choose Warehouzez in Jammu?
                        </h2>

                        <p className="block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify">
                            We offer a full range of logistics, distribution and transportation services to fulfill the demands of our clients. Warehouzez has extended its spectrum of services and solutions, creating a strong position in India's warehousing sector.
                        </p>
      ...
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
            ...
            <ul className='flex items-center flex-wrap gap-y-5 mt-4 mb-6'>
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      With our warehousing solutions, we provide businesses the much needed security and flexibility to grow and expand.
                      </span>
                      </div>
                  </li>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      We can help in keeping your stock levels and inventory management under control.
                      </span>
                      </div>
                  </li>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      Our team of professionals will help you to increase your profit margins quickly.
                      </span>
                      </div>
                  </li>
            ...
            <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
                A number of industrial sectors entrust us with their logistical and warehouse needs. Enlisted below are some of the prominent services we deal with.
            </p>
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            If you are looking for a warehouse in Jammu or anywhere else in the country, then do approach us today! At Warehouzez, it is our top-most duty to provide you with world-class supply chain management solutions. Our top-class warehousing solutions will meet all the needs and demands of your business. So, contact us today and get the best logistics services!
        </p>
