...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.kundli;
    ...
    <div>
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <h1 className="font-bold text-gray-800 text-4xl md:text-6xl xl:text-7xl mb-10">
                      Warehouse in  <br />
                      <span className='text-red'>Kundli</span>
                  </h1>
                  ...
                  <p className=" block antialiased font-sans lg:text-base leading-relaxed text-gray-700 text-justify font-normal text-sm md:text-md xl:text-lg mb-10">
                    Warehouzez: Get All Your Supply Chain Solutions At One Place!
                  </p>
              ...
              <div className="flex mx-auto lg:mx-0 align-middle">
                  <Image src={cities.kundli.cityimg} className='f-3/4 m-auto' width={500} height={500} alt="Image" />
              </div>
          </div>
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            <span className='text-4xl font-bold text-red pr-0.5'>K</span>undli, a district of Sonipat is widely regarded as a heaven for investors. It is considered as a part of the national capital region as it is located on national highway one. The city offers enormous growth opportunities in terms of industrial and economic developments. Quite soon, it will become another Cyber City after Gurgaon. Industrialization has boomed in India's leading districts ever since the country's independence. Haryana is also developing rapidly, with numerous new industries springing up in places like Sonipat and Kundli. These industries also contribute to the nation's economic growth and development. The prominent sectors in this city include Automotive and Spare parts, Packed Food Products, Computer and Electrical, among others. Various industrial sectors demand for warehouse in Kundli.
          </p>
          ...
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Since the industrial growth is accelerating in Kundli, the demand for warehousing and logistics services is also increasing rapidly. Warehouzez is indeed the perfect option for all the businesses looking for warehouse storage space in Kundli. We provide a full suite of logistics services including E-Commerce Fulfillment services, Freight Forwarding, B2B Fulfillment, On-demand Warehousing and so on. The phenomenon of smoothly and systematically moving items from source destination to the end destination is known as logistics. From packing to storage to delivery, success necessitates meticulous attention to detail. Improper logistics will, at the very most, hurt a company's profits. It can be devastating in the worst-case scenario since logistics is the physical expression of a transaction—without it, no money moves from buyer to seller. Keeping this mind, Warehouzez delivers the perfect logistics and supply chain solutions to its clients. We believe that efficiency requires automation, therefore we employ the latest technology to deliver the finest services.
          </p>
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.kundli.sideimg} alt="warehouse in kundli" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.kundli.location} />
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Excellent Supply  <br />Chain Solutions
                        </h2>
