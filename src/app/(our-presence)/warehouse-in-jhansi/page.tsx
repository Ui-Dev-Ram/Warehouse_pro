...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.jhansi;
  ...
  return (
    <div>
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <h1 className="font-bold text-gray-800 text-4xl md:text-6xl xl:text-7xl mb-10">
                      Warehouse in  <br />
                      <span className='text-red'>Jhansi</span>
                  </h1>
                  ...
                  <p className=" block antialiased font-sans lg:text-base leading-relaxed text-gray-700 text-justify font-normal text-sm md:text-md xl:text-lg mb-10">
                     Warehouzez: Get Excellent Logistics And Warehousing Solution To Grow Your Business!
                  </p>
              ...
              <div className="flex mx-auto lg:mx-0 align-middle">
                  <Image src={cities.jhansi.cityimg} className='f-3/4 m-auto' width={500} height={500} alt="Image" />
              </div>
          </div>
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            <span className='text-4xl font-bold text-red pr-0.5'>O</span>wing to an increase in the export business, India's warehousing sector has been expanding at a fast pace. The establishment of production units has generated a huge possibility for trade, which has increased the demand for warehouse spaces to manage the inventory stock. For efficient Supply Chain Management, Storage happens to be a crucial element. For all the people, investors or firms looking for a warehouse in Jhansi should connect and shake hands with Warehouzez. Warehouzez is certainly one of the most significant warehousing companies in India. We can provide you the best alternatives as we have well-maintained warehouses in different parts of the country. We handle every stage of the process, from Order Update to Invoicing to Dispatch to Distributor Partners all over India.
          </p>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Our staff members assure that inbound and outgoing operations run smoothly. Warehouzez is a popular and preferred third party logistics partner (3PL) in the country.
          </p>
          ...
          <h2 className='block antialiased tracking-normal font-sans text-2xl lg:text-2xl font-bold leading-[1.3] text-blue-gray-900 mb-2 mt-10'>
            Finest Warehousing Solutions in Jhansi
          </h2>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Jhansi is a city in India's Uttar Pradesh state, notable for its religious structures, monuments, and handicrafts, all of which reflect the area's vivid cultural and historic traditions. It lies in the region of Bundelkhand on the banks of the Pahuj River, south of Uttar Pradesh. The city offers a diverse range of business options. Its economy is heavily reliant on marketplaces and trade. Some industries in this city include Consumer Goods, Packed Food Products, Oil and Chemicals, among others. Businesses from the various industrial sectors demand for logistics and warehousing services. For everyone searching for a warehouse in Jhansi should approach and contact Warehouzez. We have a country-wide network of warehouses where you can keep your company's inventory stock in the most convenient location. Our greatest storage system in India ensures that you have the infrastructure and facilities as per your requirements. We make it a point to use the latest software and technological tools to get the best results. Warehouzez is in the list of top logistics companies of India.
          </p>
        </div>     
      </div> 
      ...
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
            ...
            <ul className='flex items-center flex-wrap gap-y-5 mt-4 mb-6'>
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      To solve all the concerns and queries of clients, Customer service is provided seven days a week, 24 hours a day.
                      </span>
                      </div>
                  </li>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      We remain focused on providing seamless end-to-end logistical and storage methods with cutting-edge technologies and software systems.
                      </span>
                      </div>
                  </li>
            </ul> 
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            If you need a warehouse for rent in Jhansi, then you can totally count on us! We will make it a point to manage all your warehousing and logistics concerns in the perfect manner. So, do connect with us today!
        </p>
