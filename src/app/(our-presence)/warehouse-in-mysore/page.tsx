...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.mysore;
    ...
    <div>
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <h1 className="font-bold text-gray-800 text-4xl md:text-6xl xl:text-7xl mb-10">
                      Warehouse in  <br />
                      <span className='text-red'>Mysore</span>
                  </h1>
                  ...
                  <p className=" block antialiased font-sans lg:text-base leading-relaxed text-gray-700 text-justify font-normal text-sm md:text-md xl:text-lg mb-10">
                    Warehouzez: Get Excellent Warehousing And Logistics <br /> Solutions For Your Business!
                  </p>
          ...
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Mysore is a prominent industrial hub of Karnataka. The prominent industries in this city include Fashion and Lifrstyle, E-Commerce and FMCG, Computer and Electrical, among others. The city has phenomenal business opportunities for everyone out there. Warehousing and logistics are inextricably linked to every company's success. For all those looking for a warehouse for rent in Mysore, should connect with Warehouzez. Warehouzez is a leading and efficient logistics service provider in the country. It offers end-to-end storage solutions for a variety of sectors. You can get the greatest possible offerings and best-in-class solutions by choosing Warehouzez. It is a one-stop destination for all supply chain management operations and effective warehouse management solutions.
          </p>
        </div>     
      </div> 
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.mysore.sideimg} alt="warehouse in mysore" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.mysore.location} /> 
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez in Mysore?
                        </h2>
      ...
      <div className="container max-w-screen-xl mx-auto">
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            If you're looking for a warehouse in Mysore, there's no need to look anywhere else. For a wide spectrum of industries, Warehouzez provides the best logistics and warehouse solutions. We use performance enhancing techniques to attain maximum efficiency. If you're searching for a 3PL partner to help you scale your business, contact us immediately.
        </p>
