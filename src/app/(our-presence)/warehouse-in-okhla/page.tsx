...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.okhla;
      ...
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <h1 className="font-bold text-gray-800 text-4xl md:text-6xl xl:text-7xl mb-10">
                      Warehouse in  <br />
                      <span className='text-red'>Okhla</span>
                  </h1>
                  ...
                  <p className=" block antialiased font-sans lg:text-base leading-relaxed text-gray-700 text-justify font-normal text-sm md:text-md xl:text-lg mb-10">
                    Warehouzez: Delivering Exceptional Warehousing And Logistics Services!
                  </p>
          ...
          <h2 className='block antialiased tracking-normal font-sans text-2xl lg:text-2xl font-bold leading-[1.3] text-blue-gray-900 mb-2 mt-10'>
            Wonderful Warehousing Solutions in Okhla
          </h2>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Okhla is a suburb area in the South East Delhi district of Delhi, close to the Uttar Pradesh border. The industrial region closest to it is known as Okhla Industrial Area. The key industrial sectors in this suburban area include Computer and Electrical, Automotive and Spare Parts, Wind, Solar and Telecom, among others. Since the industrial sectors in Okhla are on the growth trajectory, the demand for warehousing services is also increasing. Several retailers and business organizations demand for a warehouse in Okhla for various purposes. Warehouzez is certainly one of the top logistics companies in India. We have a country-wide network of warehouses where you can keep your company's inventory stock in the most convenient location. Our greatest storage system in India ensures that you have the infrastructure and facilities as per your requirements.
          </p>
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.okhla.sideimg} alt="warehouse in okhla" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.okhla.location} />
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez  <br /> in Okhla?
                        </h2>
      ...
      <div className="container max-w-screen-xl mx-auto">
        ...
        <ul className='flex items-center flex-wrap gap-y-5 mt-4 mb-6'>
            <li className='w-full lg:w-2/4'>
                ...
                <span>
                    We provide businesses a great opportunity to expand and grow. We manage storage and distribution of your products so that you can focus on your core business.
                </span>
                </div>
            </li>
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            If you are looking for a warehouse for rent in Okhla or anywhere else, please contact us right away! It is our highest priority at Warehouzez to provide you with world-class supply chain management solutions. Our top-class warehouse solutions will meet all of your company's requirements. So get in touch with us right now to get the best logistics services!
        </p>
