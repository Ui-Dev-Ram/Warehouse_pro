...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.madhavaram;
      ...
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <p className=" block antialiased font-sans lg:text-base leading-relaxed text-gray-700 text-justify font-normal text-sm md:text-md xl:text-lg mb-10">
                    Warehouzez: Experience The Top-notch Warehousing And Logistics Services!
                  </p>
              ...
              <div className="flex mx-auto lg:mx-0 align-middle">
                  <Image src={cities.madhavaram.cityimg} className='f-3/4 m-auto' width={500} height={500} alt="Image" />
              </div>
          </div>
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            <span className='text-4xl font-bold text-red pr-0.5'>T</span>he logistics industry has played a critical role in propelling several other industries as India's growth model has evolved tremendously. The key driving forces for growth in the warehousing sector are Retailing, E-commerce, modernized and advanced technologies. India's warehousing industry has been rapidly developing due to a rise in economic growth and export business. All the individuals, business owners, and stakeholders looking for a warehouse in Madhavaram or any other city should contact Warehouzez. Warehouzez is certainly one of the leading and renowned warehousing companies in India. It is the most ideal place to rent a warehouse and receive best-in-class logistics services. We have a number of warehouses in great locations.
          </p>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            We have alternatives that are a perfect fit for you in terms of infrastructure and access to the main metropolitan area.Our team of experts can help you with customized warehouse and logistical operations, short and long-term storage facilities, and other value-added solutions. Warehouzez is a prominent, popular and most preferred third party logistics partner (3PL) in the country.
          </p>
          ...
          <h2 className='block antialiased tracking-normal font-sans text-2xl lg:text-2xl font-bold leading-[1.3] text-blue-gray-900 mb-2 mt-10'>
            Finest Warehousing Services in Madhavaram
          </h2>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Madhavaram is located in North Chennai, Tamil Nadu, and India. It also has a taluk located in Chennai District and a zone located in the Greater Chennai Corporation. It is a significant historical and tourism destination in India. As a result, the tourism industry has an impact on the city's economy. The city's economy is likewise heavily reliant on trade and commerce. The major industrial sectors in this city include Packed Food Products, Fashion and Lifestyle, Automotive and Spare Parts, Computer and Electrical, among others. Industrial expansion and growth in the city has increased the demand for warehousing services. For everyone searching for a warehouse in Madhavaram should approach and contact Warehouzez. We have a country-wide network of warehouses where you can keep your company's inventory stock in the most convenient location. Our greatest storage system in India ensures that you have the infrastructure and facilities as per your requirements. We make it a point to use the latest software and technological tools to get the best results. Warehouzez is in the list of top logistics companies of India.
          </p>
        </div>     
      </div> 
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                      <Image src={cities.madhavaram.sideimg} alt="warehouse in madhavaram" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.madhavaram.location} />
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez <br /> in Madhavaram?
                        </h2>
      ...
      <div className="container max-w-screen-xl mx-auto">
        ...
        <ul className='flex items-center flex-wrap gap-y-5 mt-4 mb-6'>
            <li className='w-full lg:w-2/4'>
                ...
                <span>
                    Our mission is to build great rapport with clients based on trust, commitment, and ethical values.
                </span>
                </div>
            </li>
            ...
            <li className='w-full lg:w-2/4'>
                ...
                <span>
                    We do actually provide the most efficient, helpful, and dependable supply chain solutions.
                </span>
                </div>
            </li>
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Warehouzez has a lot to offer if you're looking for warehouse spaces at a fair price. So, say goodbye to exorbitant rental prices and take advantage of our cost-effective and high-quality logistical solutions.
        </p>
