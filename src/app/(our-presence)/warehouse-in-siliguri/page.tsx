...
const page: React.FC = () => {
    ...
    const videoData: VideoData = cities.siliguri;
  ...
  return (
    <div>
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
          <div className="flex flex-col lg:flex-row justify-between lg:mb-5 mt-10">
              <div className="text-center lg:text-left mb-20 lg:mb-0">
                  ...
                  <h1 className="font-bold text-gray-800 text-4xl md:text-6xl xl:text-7xl mb-10">
                      Warehouse in  <br />
                      <span className='text-red'>Siliguri</span>
                  </h1>
                  ...
                  Warehouzez: Digitalized Logistics And Warehousing Solutions!
                  </p>
              ...
              <div className="flex mx-auto lg:mx-0 align-middle">
                  <Image src={cities.siliguri.cityimg} className='f-3/4 m-auto' width={500} height={500} alt="Image" />
              </div>
          </div>
          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            <span className='text-4xl font-bold text-red pr-0.5'>T</span>he concept of warehousing has been around for a while now, and it has greatly helped business corporations with a myriad of different storage requirements. Using warehousing services, irrespective of your choices, can help you improve and optimize your supply chain. For all the people, business entrepreneurs or stakeholders searching for a warehouse in Siliguri or any other city of India, should get in touch with Warehouzez. Warehouzez is certainly one of the most significant warehousing companies in India. Our team of experts can help you with customized warehouse and logistical operations, short and long-term storage facilities, and other value-added solutions. We have a country-wide network of warehouses where you can keep your company's inventory stock in the most convenient location. Warehouzez is a prominent, popular and most preferred third party logistics partner (3PL) in the country.
          </p>
          ...
          <h2 className='block antialiased tracking-normal font-sans text-2xl lg:text-2xl font-bold leading-[1.3] text-blue-gray-900 mb-2 mt-10'>
            Best-in-class Warehousing services in Siliguri
          </h2>

          <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            Siliguri has long been regarded as North Bengal's most important commercial centre. This is due in part to its strategic location nearby state and international borders, which allows it to interconnect with multiple locations for trade and social purposes. Its economy is supposed to center around the four Ts: teas, tourist activities, timber, and transportation. The city is also expanding as a satellite IT centre in addition to these thriving industries. The key industrial sectors in this city include Packed Food Products, Computer and Electrical, among others. Businesses from the aforementioned industrial sectors demand for logistics and warehouse services. For everyone searching for a warehouse in Siliguri should approach and contact Warehouzez. Our greatest storage system in India ensures that you have the infrastructure and facilities as per your requirements. We make it a point to use the latest software and technological tools to get the best results. Warehouzez is in the list of top logistics companies of India.
          </p>
        </div>     
      </div> 
                ...
                <div className="flex flex-col xl:flex-row justify-end"> 
                  <div className='relative flex-1'>
                    <div className="hidden xl:block xl:absolute left-0 bottom-0 w-full">
                        <Image src={cities.siliguri.sideimg} alt="warehouse in siliguri" width={500} height={500}/>
                    </div>
                        <div className='absolute bottom-20 right-14 z-50'>
                            <MapLocation location={cities.siliguri.location} />
                        </div>
                  </div>
                    
                    <div className="flex-1">
                        <h2 className="font-semibold text-gray-900 text-xl md:text-4xl text-center leading-normal mb-6">
                            Why Choose Warehouzez in Siliguri?
                        </h2>

                        <p className="block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify">
                            Any successful business owner acknowledges how critical it is to have well-organized logistics. They comprehend that formulating smooth logistics is critical to success.We offer a full range of logistics, distribution and transportation services to fulfill the demands of our clients.
                        </p>
      ...
      <div className="container max-w-screen-xl mx-auto">
        <div className="lg:m-5">
            ...
            <ul className='flex items-center flex-wrap gap-y-5 mt-4 mb-6'>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      At Warehouzez, our team can provide fully integrated logistical and storage and distribution solutions for your company.
                      </span>
                      </div>
                  </li>
                  ...
                  <li className='w-full lg:w-2/4'>
                      ...
                      <span>
                      We seek to digitize your supply chain by utilizing cutting-edge technology and software systems.
                      </span>
                      </div>
                  </li>
        ...
        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
            If you are searching for a warehouse for rent in Siliguri or any other city of India, then Warehouzez has got you covered. Contact us today and get access to phenomenal warehousing and logistics services as per your requirements.
        </p>
