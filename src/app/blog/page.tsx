    ...
    <div>
        <div className="container m-auto">
          <div className="m-5">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-[30px] gap-y-[40px]">
               <article className="post group">
                ...
                <div className="post-info pt-6">
                    ...
                    <p className="mt-3">
                    <p>In today's fast-paced world, order picking is a crucial part of e-commerce warehouse operations.</p>
                    </p>
               ...
               <article className="post group">
                ...
                <div className="post-info pt-6">
                    ...
                    <p className="mt-3">
                    <p>With the rise of online shopping, there has been an increase in the volume of product returns.</p>
                    </p>
                    <div className="meta flex items-center mt-4">
                    <div className="flex items-center">
                        <i className="icofont-ui-calendar"></i>
               ...
               <article className="post group">
                ...
                <div className="post-info pt-6">
                    ...
                    <p className="mt-3">
                    <p>The logistics industry is constantly evolving to meet ever-changing consumer and market demands.</p>
                    </p>
                    <div className="meta flex items-center mt-4">
                    <div className="flex items-center">
                        <i className="icofont-ui-calendar"></i>
