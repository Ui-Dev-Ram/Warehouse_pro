...
import BusinessStrategy from '/public/businessStrategy/Business_Strategy.jpg'
              ...
              <div className="flex items-start">
                  <div className="flex flex-col flex-1">
                    <h2 className='block antialiased tracking-normal font-sans text-2xl lg:text-4xl font-semibold leading-[1.3] text-blue-gray-900 mb-4'>
                      ...
                      <p className='block antialiased font-sans text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
                  ...
                  <div className="relative flex-1 w-full mt-16 items-center justify-center hidden lg:block">
                    <Image src='/businessStrategy/Business_Strategy.jpg' width={450} height={400} alt="" className='relative w-3/4 m-auto' />
                    <p className='block antialiased font-sans text-base leading-relaxed font-normal text-gray-700 mb-3 mt-8 lg:pl-10 text-justify'>
                      It is absolutely necessary for every business to have an effective business strategy. The business strategies of Warehouzez are specifically designed to achieve the best possible results and to gain a competitive edge in the industry.
                    </p>
                    <p className='lg:pl-10 text-justify'>
                    We strive to grow and diversify our business. Warehouzez' business strategies are meticulously planned and carefully designed with the aim of -
                    </p>
                  </div>
              </div>
