            ...
            <div className="lg:m-5">
                <div className='mb-5'>
                    <h1 className='block antialiased tracking-normal font-sans text-2xl lg:text-4xl font-semibold leading-[1.3] text-blue-gray-900 mb-2'>
                        Fashion and Lifestyle Warehousing
                    </h1>
                </div>
                <div className="grid grip-rows-2 lg:grid-cols-3 items-start lg:gap-4 mb-8">
                    <div className="col-span-2">
                        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
                            There is no denying the fact that a well- established warehouse storage is extremely necessary for the Fashion industry. Warehousing is indeed a necessary part of the supply chain in any industry. In this regard, Fashion industry is no exception. The major hubs are located in Gurgaon and Bangalore. A significant amount of this industry's inventory is safely stored in warehouses before they get to the sales floor.To ensure success of fashion and lifestyle business, optimized warehousing facilities should be provided.
                        </p>
                        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
                            Statistics show that online fashion sales are expected to grow tremendously in the upcoming years. With this opportunity of growth for fashion and retail business, there is also a challenge to maintain efficiency. At Warehouzez, it is the primary duty to stay competitive and address the dynamic fashion trends.
                        </p>
                        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
                            As a top-notch logistics firm in the country, we strive to provide third party logistics (3PL) solutions and warehouses on lease for fashion, retail, beauty, fashion and lifestyle brands. We thoroughly understand the pressures faced by these industries, and endeavor to handle their challenges with the tech- enabled tools.
                        </p>
                        <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify'>
                            Being one of the leading warehouse and logistics service providers, we have our well- maintained warehouses in over 70 plus locations across the country. We create incredible networks to answer your service and cost problems and supply specialized IT services that suit your business requirements.
                        </p>
                ...
                <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify mt-5'>
                    Enlisted Below are Some of Our Logistics Solutions for Apparel and Lifestyle Products
                </p>
                ...
                <ul role="list" className="flex flex-wrap justify-start space-y-5 items-baseline mb-6 mt-5 gap-x-6 lg:mt-0">
                    <li className="flex flex-col space-x-3 w-full lg:w-[350px]">
                        <p className='flex place-items-starts justify-start mb-2'>
                            ...
                            <span className="text-md font-medium leading-tight text-gray-900 dark:text-white">
                                Fastest deliveries for malls and E- commerce outlets.
                            </span> 
                        </p>
                    </li>
                    ...
                    <li className="flex flex-col space-x-3 w-full lg:w-[350px]">
                        <p className='flex place-items-starts justify-start mb-2'>
                            <svg className="flex-shrink-0 w-5 h-5 text-rose-900 dark:text-rose-900 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                            <span className="text-md font-medium leading-tight text-gray-900 dark:text-white">
                                The simple and rapid settlement procedures.
                            </span> 
                        </p>
                    </li>
                    ...
                    <li className="flex flex-col space-x-3 w-full lg:w-[350px]">
                        ...
                        <svg className="flex-shrink-0 w-5 h-5 text-rose-900 dark:text-rose-900 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                        <span className="text-md font-medium leading-tight text-gray-900 dark:text-white">
                            Repacking and return process that is quick and easy, with real-time reports.
                        </span> 
                        </p>
                    </li>
                    ...
                    <li className="flex flex-col space-x-3 w-full lg:w-[350px]">
                        ...
                        <svg className="flex-shrink-0 w-5 h-5 text-rose-900 dark:text-rose-900 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                        <span className="text-md font-medium leading-tight text-gray-900 dark:text-white">
                            Cutting-edge Warehousing and Storage solutions.
                        </span> 
                        </p>
                    </li>
                    ...
                    <li className="flex flex-col space-x-3 w-full lg:w-[350px]">
                        ...
                        <svg className="flex-shrink-0 w-5 h-5 text-rose-900 dark:text-rose-900 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                        <span className="text-md font-medium leading-tight text-gray-900 dark:text-white">
                            Supply Chain Management from Door to Door.
                        </span> 
                        </p>
                    </li>
                ...
                <h2 className='block antialiased tracking-normal font-sans text-xl lg:text-2xl font-semibold leading-[1.3] text-blue-gray-900 mt-5 mb-2'>
                    With years of industry experience and dealing with premier automakers and tier-one suppliers from all over the world, Warehouzez can assist you
                </h2>
                ...
                <ul role="list" className="flex flex-wrap justify-start space-y-5 items-baseline mb-6 mt-5 gap-x-6 lg:mt-0">
                    <li className="flex flex-col space-x-3 w-full lg:w-[350px]">
                        <p className='flex place-items-starts justify-start mb-2'>
                            <svg className="flex-shrink-0 w-5 h-5 text-rose-900 dark:text-rose-900 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                            <span className="text-md font-medium leading-tight text-gray-900 dark:text-white">
                                Enhance the product development cycle for fortuitous launch.
                            </span> 
                        </p>
                    </li>
                    ...
                    <li className="flex flex-col space-x-3 w-full lg:w-[350px]">
                        ...
                        <svg className="flex-shrink-0 w-5 h-5 text-rose-900 dark:text-rose-900 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                        <span className="text-md font-medium leading-tight text-gray-900 dark:text-white">
                            Finest logistics solutions to cut down your expenses.
                        </span> 
                        </p>
                    </li>
                </ul>
                ...
                <p className='block antialiased font-sans text-sm lg:text-base leading-relaxed font-normal text-gray-700 mb-3 text-justify mt-5'>
                    Warehouzez The Digital Supply Chain offers premium quality warehousing and logistics services for a wide range of products like Apparel, Retail and Lifestyle products.
                </p>
