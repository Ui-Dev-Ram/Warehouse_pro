...
const Testimonial = () => {
  ...
  return (
    <section className="bg-gray-50">
        <div className="mx-auto py-12 lg:py-14 xl:py-20">
            <div className="items-end justify-between sm:flex m-auto">
                <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl m-auto text-center">
                    Testimonial
            ...
            <div className='container mx-auto'>
                <div className="-mx-6 mt-8 lg:col-span-2 lg:mx-0">
                    <div id="keen-slider" className="keen-slider">
                        <Carousel className='m-auto lg:w-full h-full pb-16' autoPlay={true} responsive={responsive}  infinite={true}  removeArrowOnDeviceType={["desktop", "mobile"]} swipeable={true} draggable={true} showDots={true}>
                            {
