...
const MapLocation = () => {
  return (
    <div>
        <Link href="https://goo.gl/maps/dn9AANtaZ9XpexFj7" className="relative inline-flex items-center justify-center p-4 px-10 py-3 overflow-hidden font-medium text-red transition duration-300 ease-out border-2 border-white rounded-full shadow-md group">
